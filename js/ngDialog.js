...
(function (root, factory) {
    ...
    m.provider('ngDialog', function () {
        ...
        this.$get = ['$document', '$templateCache', '$compile', '$q', '$http', '$rootScope', '$timeout', '$window', '$controller', '$injector', 'ElementScroll',
            function ($document, $templateCache, $compile, $q, $http, $rootScope, $timeout, $window, $controller, $injector, ElementScroll) {
                var $elements = [];
                ...
                var privateMethods = {
                    ...
                    performCloseDialog: function ($dialog, value) {
                        ...
                        ElementScroll.enableScrolling(angular.element($window));
                    ...
                    open: function (opts) {
                        ...
                        $q.all({
                            ...
                            $timeout(function () {
                                ...
                                ElementScroll.disableScrolling(angular.element($window));
                                // stops valid internal dialog events from getting blocked
                                $dialog.on('mousewheel DOMMouseScroll touchmove scroll keydown', function(event){
    ...
    m.service('ElementScroll', ['$window', function($window) {
        // Service from: https://github.com/Skinner927/angular-disablescroll
        var proto;
        var instances = {};
